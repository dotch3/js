...
*/
 ...
 let newFoodsInfo = `Até aqui, o array \"brazilianFoods\"possui ${brazilianFoods.length} itens: ${brazilianFoods[0]},  ${brazilianFoods[1]} e  ${brazilianFoods[2]}.`;
...
dogNames.push('Nina')
const initials = `${dogNames[0].charAt(0)}${dogNames[1].charAt(0)}${dogNames[2].charAt(0)}`
const initials2 = `${dogNames[0][0]}${dogNames[1][0]}${dogNames[2][0]}`
...
oddNumbers[1]+=4;
console.log(Math.pow(oddNumbers[1],3))
console.log(oddNumbers[1] ** 3)  //Exponente utiliza o ** também
