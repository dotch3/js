...
const my3FavoriteTVShows = ['TheChosen', 'Other' , 'MoreOne']
// const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows[0]}, ${my3FavoriteTVShows[1]} e ${my3FavoriteTVShows[2]}.`
const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ').replace(', M', ' e M')}`
...
const numCaracteres = 39
const numTypeSentence= typeSentence.length
const bol =  String (numTypeSentence >  numCaracteres)
console.log(`A string que a "typeSentence" armazena tem mais de ${numCaracteres}  
  caracteres? ${bol[0].toUpperCase()}${bol.slice(1)}.`)
...
console.log(crazyConversion) // valor truthy
...
console.log(evenNumbers.indexOf(8) !== -1) // indexOf retorna o -1 se não encontra o item
