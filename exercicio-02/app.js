...
const mensagem='Grandes poderes trazem grandes responsabilidades.'
...
const js = programmingLanguage.charAt(programmingLanguage.indexOf('J')) + programmingLanguage.charAt(programmingLanguage.indexOf('S'));
// console.log(js);
